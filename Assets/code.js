...
var input = document.querySelector(".sidebar input");
var apiKey = "668e3d39d52a645e064391881ef3df01";
...
function setToLocalStorage(data) {
  let value = JSON.parse(localStorage.getItem("myWeatherData"));
  let newArray = [];
  if (value) {
